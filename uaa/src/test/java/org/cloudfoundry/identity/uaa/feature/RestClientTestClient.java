...
public class RestClientTestClient implements TestClient {
    ...
    public RestClientTestClient(RestTemplate restTemplate) {
    ...
    public String getOAuthAccessToken(String username, String password, String grantType, String scope) {
        ...
        ResponseEntity<Map> exchange = restTemplate.exchange("http://localhost:9090/uaa/oauth/token", HttpMethod.POST, requestEntity, Map.class);
